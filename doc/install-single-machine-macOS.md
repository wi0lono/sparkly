...
This command will install Sparkly and all of its dependencies, such as Joblib, mmh3, Numba, Numpy, Numpydoc, Pandas, Psutil, Pyarrow, Pyspark, Scipy, and Tqdm, _except Java, JCC, and PyLucene._
...
Similar to pip installing from PyPI, the above command will install Sparkly and all of its dependencies, _except Java, JCC, and PyLucene._
...
The last step to install will be running a very similar command to the last. Make sure to change the two instances of username again before running the command:
